...
public class DeathMessages {
	...
	public String getDeathMessage(Player player, Player killer) {
		...
		if (killer.getItemInHand().getTypeId() != 0) {
			returnVal = ChatColor.AQUA + player.getDisplayName()
					+ ChatColor.RED + " was killed by " + ChatColor.AQUA
					+ killer.getDisplayName() + ChatColor.RED + " wielding "
					+ ChatColor.YELLOW + getItemName(killer.getItemInHand())
					+ ".";
		} else {
			returnVal = ChatColor.AQUA + player.getDisplayName()
					+ ChatColor.RED + " was savagely beaten to death by "
					+ ChatColor.AQUA + killer.getDisplayName() + ".";
		}
	...
	private String itemNameListUgghh(int i) {
		String rs = Material.values()[i].toString();
		...
		case 7:
			...
			break;
		case 8:
			rs = "Water. " + ChatColor.RED
					+ "Clearly someone is a Staff/Hacker";
			break;
		case 9:
			rs = "Water. " + ChatColor.RED
					+ "Clearly someone is a Staff/Hacker";
